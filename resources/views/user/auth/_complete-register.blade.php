                ...
                <div class="row flex-grow">
                    <div class="col-lg-6 d-flex align-items-center justify-content-center">
                        <div class="auth-form-transparent text-left p-3">
                            ...
                            <h6 class="font-weight-light">Submit account information to complete registration.
                                {{ session('userId') }}</h6>
                            <form class="pt-3" method="POST" action="{{ route('cregister') }}">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control form-control-lg border-left-0"
                                            placeholder="Bank Name" name="bankName" value="{{ old('bankName') }}">
                                    </div>
                                    @error('bankName')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mt-3">
                                    <button type="submit"
                                        class="btn btn-block btn-info btn-lg font-weight-medium auth-form-btn">Complete
                                        Registration </button>
                                </div>
