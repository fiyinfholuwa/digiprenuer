            ...
            <ul class="navbar-nav flex-row">
                <li>
                    <div class="page-header">
                        <h4>Welcome back! {{ucfirst(Auth::user()->user_type)}} (Admin)</h4>
                    </div>
                </li>
            </ul>
        </header>
        ...
        <div class="sidebar-wrapper sidebar-theme">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    <li class="menu">
                        <a href="{{route('admin.dashboard')}}" data-active="true" data-toggle="collapsee" aria-expanded="true"
                    ...
                    <li class="menu">
                        <a href="{{route('admin.task.view')}}"  aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
